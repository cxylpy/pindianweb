...
<ul class="side_navigation">
	...
	<li class="sub_title"><a style="color:#da251c" href="${pageContext.request.contextPath}/manager/addRoleView">添加角色</a></li>
	<li class="sub_title"><a  href="${pageContext.request.contextPath}/manager/showGlobalSettings">积分比例</a></li>
</ul>
<div class="main_iframe">
	<form action="${pageContext.request.contextPath}/manager/addRole"
		method="post">
		<table>
			<tr>
				<td class="firsttd">
			...
			<tr>
				...
				<td>
					...
					<label><input type="checkbox" name="privileges" value="${p.id}"/>${p.name} 　</label>
					</c:forEach>
				</td>
			</tr>
			<tr>

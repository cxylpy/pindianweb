...
<ul class="side_navigation">
	...
	<li class="sub_title"><a style="color:#da251c" href="${pageContext.request.contextPath}/manager/jsp_newa4package">礼包发布</a></li>
	<li class="sub_title"><a href="${pageContext.request.contextPath}/manager/showAllA4package">礼包管理</a></li>
</ul>
<div class="main_iframe">
	<form action="${pageContext.request.contextPath}/manager/addA4package"
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="pages" />页</td>
			</tr>
			<tr>
				<td>
					<p>红包数量</p>

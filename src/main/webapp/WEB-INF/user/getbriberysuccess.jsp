	...
	<div id="bg">
		<div class="centerblock">
			...
			<table>
				...
				<tr><td colspan="2"><p>面额：<span>￥${b.price}</span></p></td></tr>
				<tr><td colspan="2"><p>使用门槛：订单满${b.minPrice}元使用</p></td></tr>
				<tr><td colspan="2"><p>使用时间：<span>${fn:split(b.createTime," ")[0]}至${fn:split(b.validDate," ")[0]}</span></p></td></tr>

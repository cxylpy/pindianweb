	...
	<div class="container">
		...
		<ul class="side_navigation">
			...
			<li class="main_title">用户须知
				<ul>
					<li class="sub_title"><a 
						href="${pageContext.request.contextPath}/jsp_paystandard"style="color:#da251c">收费标准</a></li>
				</ul>
			</li>
		</ul>
		<!--侧面导航栏-->
		<div class="right_container">
			<img class="paystandard" src="${pageContext.request.contextPath}/images/paystandard.jpg"/>
		</div>
</body>
</html>
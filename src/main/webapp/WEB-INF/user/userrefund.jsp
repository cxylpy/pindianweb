...
<div class="navigation_user">
	...
	<div class="container">
		...
		<ul class="side_navigation">
			<li class="main_title">我的交易
				<ul>
					...
					<li class="sub_title"><a 
						href="${pageContext.request.contextPath}/jsp_userrefund" style="color:#da251c">申请退款</a></li>
		...
		<div class="right_container">
			...
			<br/>			
			<br/>			
				<p>如您需要办理退款，请在<a href="https://www.alipay.com/" target="_blank">支付宝</a>上进行相应操作</p>
				<br/>
				<br/>
				
				<p>我们会在<a href="https://www.alipay.com/" target="_blank">支付宝</a>上进行退款业务的受理</p>
			</div>
